...
usuario = {} #DICIONARIO PARA ARMAZENAR LOGIN/SENHA estoq = {} #DICIONARIO ESTOQUE balanco_de_caixa = [] #LISTA PARA BALANÇO DE CAIXA lista_de_compras = [] #LISTA P/ ACIONAR ITENS AO CARRINHO DE COMPRAS soma_total = [] #LISTA AUXILIAR P/ SOMAR VALORES

def somar_elementos(soma_total): #SOMA VALORES DO CAIXA soma_t = 0 for i in soma_total: soma_t += i return soma_t

#▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ MENU INICIAL ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀

def inicio(): abc_inicio = "═"*13 print (" ╔═%s╗" %(abc_inicio)) print (" ║ Menu Inícial ║") print (" ╚═%s╝" %(abc_inicio))
...
[2] Login Digite sua opção: """) a = False if cad != "1" and cad != "2": print (" > Opção invalida!\n") a = True elif cad =="1": os.system("cls") #LIMPA TELA DO PROMPT cadastro() #REDIRECIONA AO MENU CADASTRO elif cad == "2": os.system("cls") login() #REDIRECIONA AO MENU LOGIN

#▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ CADASTRAMENTO ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀

def cadastro(): abc_cadastro = "═"*14 print (" ╔═%s╗" %(abc_cadastro)) print (" ║ Cadastramento ║") print (" ╚═%s╝" %(abc_cadastro))
...
def login(): abc_login = "═"*6 print (" ╔═%s╗" %(abc_login)) print (" ║ Login ║") print (" ╚═%s╝\n" %(abc_login))
...
def opcoes(): abc_opcoes = "═"*15 print (" ╔═%s╗" %(abc_opcoes)) print (" ║ Menu de Opções ║") print (" ╚═%s╝" %(abc_opcoes))

a = True
while a:
	opcao = input("""[1]| Início
[2]| Caixa [3]| Estoque Digite sua opção? """) a = False if opcao != "1" and opcao != "2" and opcao != "3": #CONDICIONAL P/ OPÇÃO INVALIDA print (" > Opção invalida!\n") a = True elif opcao == "1": os.system("cls") #LIMPA TELA DO PROMPT inicio() #REDIRECIONA AO MENU INÍCIO elif opcao == "2": os.system("cls") caixa() #REDIRECIONA AO MENU CAIXA elif opcao == "3": os.system("cls") #LIMPA TELA DO PROMPT estoque() #REDIRECIONA AO MENU ESTOQUE

#▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ CONTROLE DE ESTOQUE ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀

def estoque(): abc_estoque = "═"*20 print (" ╔═%s╗" %(abc_estoque)) print (" ║ Controle de Estoque ║") print (" ╚═%s╝" %(abc_estoque))

cond = True
while cond:
	menu_estoque = input("""[1] | Exibir Estoque              |
[2] | Consutar Produto no Estoque | [3] | Cadastrar novo Produto | [4] | Alterar Produto no Estoque | [5] | Excluir produto no estoque | [6] | Voltar ao menu anterior |

Digite sua opção: """) cond = False if menu_estoque != "1" and menu_estoque != "2" and menu_estoque != "3" and menu_estoque != "4" and menu_estoque != "5" and menu_estoque != "6": os.system("cls") print ("\n > Opção invalida!\n") print (" ╔═%s╗" %(abc_estoque)) print (" ║ Controle de Estoque ║") print (" ╚═%s╝" %(abc_estoque)) cond = True
...
Ou qualquer outra tecla para CADASTRAR novo produto no estoque: """) if retorno == "": cond_estoq = False os.system("cls") estoque() #RETORNA AO MENU ESTOQUE else: cond_estoq = True elif menu_estoque == "4": #Altera Produtos no Estoque os.system("cls") print (" ╔═%s╗" %(abc_estoque)) print (" ║ Controle de Estoque ║") print (" ╚═%s╝" %(abc_estoque))
...
[3] |Alterar Quantidade do Produto [4] |Exibir Estoque [5] |Voltar

Digite sua opção: """)) if alteracao != "1" and alteracao != "2" and alteracao != "3" and alteracao != "4" and alteracao != "5": print (" > Opção invalida") cond_alt_est = True
		...
		opcoes()
#▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ CAIXA ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ def abc(): abc_caixa = "═"*7 print ("\n ╔═%s╗" %(abc_caixa)) print (" ║ VENDAS ║") #CABEÇARIO P/ TELA DE VENDAS print (" ╚═%s╝" %(abc_caixa)) print (" Digite 'FIM' para finalizar a venda.\n") #EXIBE UMA INSTRUÇÃO AO USUSÁRIO

def caixa(): abc_caixa = "═"*14 print (" ╔═%s╗" %(abc_caixa)) print (" ║ MENU DE CAIXA ║") print (" ╚═%s╝" %(abc_caixa))
...
[2]| Balanço de Caixa [3]| Voltar ao Menu Opções
